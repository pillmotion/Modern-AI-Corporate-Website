export const translations = {
  en: {
    ...
    emptySegmentText: 'Write or paste your story here',
    promptSaved: 'Prompt saved',
    editImagePrompt: 'Edit Image Prompt',
    editPromptDescription: 'Edit the image prompt to generate a new image',
    prompt: 'Prompt',
  ...
  zh: {
    ...
    imageError: '图像生成失败',
    generateImage: '生成图像',
    emptySegmentText: '写或粘贴你的故事',
    promptSaved: '提示已保存',
    editImagePrompt: '编辑图像提示',
    editPromptDescription: '编辑图像提示以生成新图像',
    prompt: '提示',
    enterPrompt: '输入提示...',
    savePrompt: '保存提示',
